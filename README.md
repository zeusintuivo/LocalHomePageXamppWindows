...
<Directory "/www">
  ...
  <Virtualhost *:80>
    VirtualDocumentRoot "C:/xampp/htdocs/%1/html"
    ServerName %1.dev
    ServerAlias *.dev
    UseCanonicalName Off
  </Virtualhost>
...
*/
$devtools = array(
	array( 'name' => 'PHPInfo', 'url' => 'http://home.dev/phpinfo.php' ),
	array( 'name' => 'XAMPP Admin', 'url' => 'http://home.dev/xampp' ),
	array( 'name' => 'phpMyAdmin', 'url' => 'http://home.dev/phpmyadmin/#' ),
...
$siteoptions = array(
  //'dirname' => 'Display Name',
   'dirname' => array( 'displayname' => 'My Apache 2.4.9', 'adminurl' => 'http://home.dev/admin' ),
